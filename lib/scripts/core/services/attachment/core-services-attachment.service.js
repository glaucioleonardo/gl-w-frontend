...
class Parser {
    ...
    populateFiles(attachmentsData) {
        const attachments = [];
        const userAttachments = attachmentsData.filter(x => x.new);
...
class Validate {
    ...
    duplicated(fileName, attachmentList) {
