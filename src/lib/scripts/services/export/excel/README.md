# gl-w-excel-frontend #
[![version](https://img.shields.io/npm/v/gl-w-excel-frontend)](https://www.npmjs.com/package/gl-w-excel-frontend) 
[![downloads](https://img.shields.io/npm/types/gl-w-excel-frontend)](https://www.npmjs.com/package/gl-w-excel-frontend) 
[![downloads](https://img.shields.io/npm/dw/gl-w-excel-frontend)](https://www.npmjs.com/package/gl-w-excel-frontend) 

### What is this repository for? ###
This package (**g**laucio**l**eonardo-**w**eb-excel-**frontend**) is a common code for using among web front-end development 
...
* Latest version `npm install gl-w-excel-frontend --save`;
* [Available versions](https://www.npmjs.com/package/gl-w-excel-frontend?activeTab=versions) `npm install gl-w--excelfrontend@version --save`;
