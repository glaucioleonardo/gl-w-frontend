# gl-w-international-frontend #
[![version](https://img.shields.io/npm/v/gl-w-international-frontend)](https://www.npmjs.com/package/gl-w-international-frontend) 
[![downloads](https://img.shields.io/npm/types/gl-w-international-frontend)](https://www.npmjs.com/package/gl-w-international-frontend) 
[![downloads](https://img.shields.io/npm/dw/gl-w-international-frontend)](https://www.npmjs.com/package/gl-w-international-frontend) 

### What is this repository for? ###
This package (**g**laucio**l**eonardo-**w**eb-international-**frontend**) is a common code for using among web front-end development 
...
* Latest version `npm install gl-w-international-frontend --save`;
* [Available versions](https://www.npmjs.com/package/gl-w-international-frontend?activeTab=versions) `npm install gl-w-international-frontend@version --save`;
