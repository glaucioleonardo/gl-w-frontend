...
[![version](https://img.shields.io/npm/v/gl-w-attachment-frontend)](https://www.npmjs.com/package/gl-w-attachment-frontend) 
[![downloads](https://img.shields.io/npm/types/gl-w-attachment-frontend)](https://www.npmjs.com/package/gl-w-attachment-frontend) 
[![downloads](https://img.shields.io/npm/dw/gl-w-attachment-frontend)](https://www.npmjs.com/package/gl-w-attachment-frontend) 

### What is this repository for? ###
This package (**g**laucio**l**eonardo-**w**eb-attachment-**frontend**) is a common code for using among web front-end development 
...
* [Available versions](https://www.npmjs.com/package/gl-w-attachment-frontend?activeTab=versions) `npm install gl-w-attachment-frontend@version --save`;
