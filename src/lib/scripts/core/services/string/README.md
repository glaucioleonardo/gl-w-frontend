...
[![version](https://img.shields.io/npm/v/gl-w-string-frontend)](https://www.npmjs.com/package/gl-w-string-frontend) 
[![downloads](https://img.shields.io/npm/types/gl-w-string-frontend)](https://www.npmjs.com/package/gl-w-string-frontend) 
[![downloads](https://img.shields.io/npm/dw/gl-w-string-frontend)](https://www.npmjs.com/package/gl-w-string-frontend) 

### What is this repository for? ###
This package (**g**laucio**l**eonardo-**w**eb-string-**frontend**) is a common code for using among web front-end development 
...
* Latest version `npm install gl-w-string-frontend --save`;
* [Available versions](https://www.npmjs.com/package/gl-w-string-frontend?activeTab=versions) `npm install gl-w-string-frontend@version --save`;
