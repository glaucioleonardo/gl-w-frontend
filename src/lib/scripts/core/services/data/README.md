# gl-w-data-frontend #
[![version](https://img.shields.io/npm/v/gl-w-data-frontend)](https://www.npmjs.com/package/gl-w-data-frontend) 
[![downloads](https://img.shields.io/npm/types/gl-w-data-frontend)](https://www.npmjs.com/package/gl-w-data-frontend) 
[![downloads](https://img.shields.io/npm/dw/gl-w-data-frontend)](https://www.npmjs.com/package/gl-w-data-frontend) 

### What is this repository for? ###
This package (**g**laucio**l**eonardo-**w**eb-data-**frontend**) is a common code for using among web front-end development 
...
* Latest version `npm install gl-w-data-frontend --save`;
* [Available versions](https://www.npmjs.com/package/gl-w-data-frontend?activeTab=versions) `npm install gl-w-data-frontend@version --save`;
