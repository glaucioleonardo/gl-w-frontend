# gl-w-menu-frontend #
[![version](https://img.shields.io/npm/v/gl-w-menu-frontend)](https://www.npmjs.com/package/gl-w-menu-frontend) 
[![downloads](https://img.shields.io/npm/types/gl-w-menu-frontend)](https://www.npmjs.com/package/gl-w-menu-frontend) 
[![downloads](https://img.shields.io/npm/dw/gl-w-menu-frontend)](https://www.npmjs.com/package/gl-w-menu-frontend) 

### What is this repository for? ###
This package (**g**laucio**l**eonardo-**w**eb-menu-**frontend**) is a common code for using among web front-end development 
...
* Latest version `npm install gl-w-menu-frontend --save`;
* [Available versions](https://www.npmjs.com/package/gl-w-menu-frontend?activeTab=versions) `npm install gl-w-menu-frontend@version --save`;
