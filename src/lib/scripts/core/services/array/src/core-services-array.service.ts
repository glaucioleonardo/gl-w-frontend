class Remove {
  ...
  async duplicate(array: any[], sort = false, asc = true): Promise<any[]> {
  ...
  async duplicatedByKey(data: any[], identification: any, sortIdentification?: string, asc = true): Promise<any[]> {
    const array: any[] = [];
  ...
  async notDuplicated(array: any[], asc = true): Promise<any[]> {
    const arrayWithoutDuplicates = [...new Set(array)];
  ...
  async notDuplicatedByKey(data: any[], identification: any, sortIdentification?: string, asc = true): Promise<any[]> {
    const array: any[] = [];
    for (const item of data) {
      array.push(item[identification]);
    }
